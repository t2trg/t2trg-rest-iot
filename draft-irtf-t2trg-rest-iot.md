...
CoAP responses with code 2.05, 4.xx, and 5.xx are cacheable, and responses with code 2.03 update the cache lifetime (MaxAge option) of an existing cached response.
