...
CoAP response codes are encoded as a single byte split into a 3-bit class and a 5-bit detail (e.g., 4.04), giving them a similar structure to HTTP codes with a more compact on-wire representation.
